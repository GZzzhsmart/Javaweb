...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" method="post" action="<%=path%>/lpimg/addloupanimg">
		<div class="row cl">
			<label class="form-label col-xs-5 col-sm-2">图片上传：</label>
				...
				<div class="uploader-list-container"> 
					...
					<div class="statusBar" style="display:none;">
						...
						<div class="btns">
							...
							<div class="uploadBtn" id="up" onclick="return up();">开始上传</div>
						</div>
					</div>
				</div>
			</div>
...
$(function(){
	...
	var uploader = WebUploader.create({
		...
		// 文件接收服务端。
		server: '${pageContext.request.contextPath}/lpimg/fileUpload',
